                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Shop.php?action=add&id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="product">	
							     ...
							     <li><img  width="110" height="150"  src="<?php echo $row["image"]; ?>" class="img-responsive">
...
$stmt = $mysqli->prepare("SELECT img,imglink FROM low WHERE ID = ?");
$stmt->bind_param("i", $ID);
$stmt->execute();
$stmt->bind_result($img,$imglink);
$stmt->fetch();
