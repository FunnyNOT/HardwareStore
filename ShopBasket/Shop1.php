...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="Shop.php">Laptops</a></li>   
    <a href="Shop1.php">Μητρικές Κάρτες</a>
	<a href="Shop2.php">Μνήμες RAM</a>
  </div>
...
<h2>Laptops</h2>
            <li>
                  <?php
            $query = "SELECT * FROM low ORDER BY kwd ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Shop1.php?action=add&id=<?php echo $row["kwd"]; ?>">

                            <div class="product">	
							
							     <li><img  width="60" height="100"  src="<?php echo $row["img"]; ?>" class="img-responsive">
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="Shop1.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
