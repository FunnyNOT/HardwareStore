            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Shop2.php?action=add&id=<?php echo $row["id"]; ?>">

                            <div class="product">	
							
							     <li><img  width="60" height="100"  src="<?php echo $row["image"]; ?>" class="img-responsive">
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="Shop2.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
