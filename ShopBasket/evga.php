    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="evga.php"</script>';
            }else{
...
<h2>Κάρτες Γραφικών</h2>
            <li>
                  <?php
            $query = "SELECT * FROM kartes_grafikwn WHERE id='23' ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="evga.php?action=add&id=<?php echo $row["id"]; ?>">
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="evga.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
