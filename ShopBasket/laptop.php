...
<h2>Laptops</h2>
            <li>
                  <?php
            $query = "SELECT * FROM laptop ORDER BY kodikos ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="laptop.php?action=add&id=<?php echo $row["kodikos"]; ?>">
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="laptop.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
