...
<h2>Οθόνες</h2>
            <li>
                  <?php
            $query = "SELECT * FROM othoni WHERE kod='12' ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="lg.php?action=add&id=<?php echo $row["kod"]; ?>">
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="lg.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
