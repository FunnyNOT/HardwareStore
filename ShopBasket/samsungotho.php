    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="samsungotho.php"</script>';
            }else{
...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="kartesgrafikon.php">Κάρτες Γραφικών</a>
...
<h2>Οθόνες</h2>
            <li>
                  <?php
            $query = "SELECT * FROM othoni WHERE kod='10' ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="samsungotho.php?action=add&id=<?php echo $row["kod"]; ?>">

                            <div class="product">
							
							  <li><a href="<?php echo $row["imagelink"]?>"><img  width="200" height="150"  src="<?php echo $row["image"]; ?>" class="img-responsive"></a>
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                           ...
                           <td> <?php echo $value["item_name"]; ?></td>
                            ...
                            <td class="delete"><a href="samsungotho.php?action=delete&id=<?php echo $value["product_id"] ?>"><span
